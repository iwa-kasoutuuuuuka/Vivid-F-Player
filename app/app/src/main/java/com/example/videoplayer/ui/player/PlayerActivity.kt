    ...
    private fun setupGestures() {
        ...
        val gestureDetector = GestureDetector(this, object : GestureDetector.SimpleOnGestureListener() {
            ...
            override fun onSingleTapConfirmed(e: MotionEvent): Boolean {
                binding.controlsLayout.visibility = if (binding.controlsLayout.visibility == View.VISIBLE) View.GONE else View.VISIBLE
                return true
            }
        })
    ...
    override fun onPause() {
        ...
        folderUri?.let { uri ->
            currentFileName?.let { fileName ->
                ResumeManager(this).saveResumePosition(uri, fileName, playerManager.player.currentPosition)
            }
        }
    }
